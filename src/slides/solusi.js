      ...
      <div class="slide-inner">
        ...
        <div class="grid-4">
          ...
          <div class="card sol-card">
            ...
            <div class="sol-desc">Mengatur siapa yang bisa melihat dashboard apa secara terpusat melalui manajemen <i>Position Menu</i>.</div>
          </div>
          <div class="card sol-card">
            ...
            <div class="sol-title">Mode Kiosk / Slideshow</div>
            <div class="sol-desc">Menambahkan fitur putar otomatis (slideshow) secara <i>fullscreen</i> untuk kebutuhan layar publik.</div>
          </div>
          <div class="card sol-card">
            ...
            <div class="sol-title">Mobile Friendly</div>
            <div class="sol-desc">Membuat aplikasi dapat berjalan di perangkat Android secara <i>native</i>.</div>
          </div>
        </div>
      </div>
    `;
